...
export default function WorkerSettings() {
  ...
  return (
    <>
      <style>{`
        .ws-page   { font-family:'DM Sans',sans-serif; padding-bottom:24px; }
        .ws-layout { display:grid; grid-template-columns:1fr 300px; gap:16px; align-items:start; }
        .ws-left   { display:flex; flex-direction:column; gap:14px; }
        .ws-right  { display:flex; flex-direction:column; gap:14px; position:sticky; top:80px; }
      ...
      <div className="ws-page">
        ...
        <div className="ws-layout">
          ...
          <div className="ws-left">
            ...
            <div style={s.card}>
              ...
              <div style={{ marginTop:16, display:"flex", flexDirection:"column", gap:12 }}>
                ...
                <div>
                  <p style={s.lbl}>Role</p>
                  <input style={{ ...s.inp, opacity:0.6, cursor:"not-allowed" }}
                    value="Worker" disabled />
                </div>
            ...
            <div style={s.card}>
              ...
              <p style={{ fontSize:12, color:"rgba(255,255,255,0.4)", margin:"8px 0 16px", lineHeight:1.5 }}>
                Click below and we'll send a password reset link to your registered email address.
              </p>
          ...
          <div className="ws-right">
            ...
            <div style={s.card}>
              ...
              <div style={{ marginTop:14, display:"flex", flexDirection:"column", gap:10 }}>
                {[
                  ...
                  { label:"Email",    value: user?.email?.slice(0,22) + "..." },
            ...
            {/* Tech Stack Info */}
            <div style={{ ...s.card, background:"rgba(124,58,237,0.06)", border:"1px solid rgba(124,58,237,0.15)" }}>
              <p style={s.cardTitle}>🛡️ Security Info</p>
              <div style={{ marginTop:12, display:"flex", flexDirection:"column", gap:8 }}>
                {[
                  { icon:"🔒", text:"Your data is encrypted" },
